...
public class Main05 {
    ...
    private static class CustomAnalyzer extends Analyzer {
        ...
        protected TokenStreamComponents createComponents(String fieldName, Reader reader) {
            ...
            TurkishLowerCaseFilter lowerCaseFilter = new TurkishLowerCaseFilter(lengthFilter);
            StopFilter             stopFilter      = new StopFilter(Version.LUCENE_46, lowerCaseFilter, stopWords);
